...
node increase_key(struct priority_queue *p_queue, int x, int k);  //Increase value of x to k
node h_delete(struct priority_queue *p_queue, int x);             //Delete element x
...
node extract_min(struct priority_queue *p_queue){
    ...
    struct node min = p_queue->heap[0];
...
node change_key(struct priority_queue *p_queue, int x, int k, int p){
...
node change_p(struct priority_queue *p_queue, int x, int p){
...
node increase_key(struct priority_queue *p_queue, int x, int k){
...
node decrease_key(struct priority_queue *p_queue, int x, int k){
...
node h_delete(struct priority_queue *p_queue, int x){
